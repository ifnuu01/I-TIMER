...
function TimerForm({ timer, setTimer, onStart }: TimerFormProps) {
    ...
    return (
        <div className="flex items-center justify-center flex-col h-screen text-white p-4 md:p-0">
            <h1 className="bg-custom-dark p-10 rounded-lg text-4xl shadow-lg font-bold shadow-fuchsia-900">I-TIMER</h1>
            <div className="flex items-center gap-4 mt-8 w-full md:w-1/2 md:flex-row flex-col">
            ...
            <button
                ...
                className='mt-8 flex justify-center font-bold bg-custom-dark rounded-lg shadow-lg py-5 w-full md:w-1/2 cursor-pointer hover:scale-110'><Play /></button>
            <Footer />
        </div>
    )
}
